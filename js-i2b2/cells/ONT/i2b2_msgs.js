...
'    </request_header>\n'+
'    <message_body>\n'+
'        <ns4:get_name_info blob="true" includeParent="true" type="core" {{{ont_max_records}}} reducedResults="{{{ont_reduce_results}}}" keyname="{{{ont_hierarchy}}}" hiddens="{{{ont_hidden_records}}}" synonyms="{{{ont_synonym_records}}}" category="{{{ont_category}}}">\n'+
